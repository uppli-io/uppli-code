...
pub fn calculate_context_window_usage(messages: &[Message], context_window: u64) -> ContextUsage {
...
// context_window_for_model() removed — use provider.context_window(model) instead.
