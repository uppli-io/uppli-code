//! Output style system — customises how the model responds to the user.
//!
...
//!   - Global: `~/.uppli/output-styles/`
//!   - Project: `.uppli/output-styles/`
//!
...
impl OutputStyleDef {
    ...
    pub fn builtin_default() -> Self {
        Self {
            ...
            description: "Standard Uppli Code responses.".to_string(),
            prompt: String::new(),
        }
    }
