// tips.rs — Tip scheduling system for Uppli Code.
//
// Ported from:
...
//
// History is persisted to `~/.uppli/tip_history.json`.
...
static ALL_TIPS: Lazy<Vec<Tip>> = Lazy::new(|| {
    vec![
        Tip {
            id: "new-user-warmup",
            content: "Start with small features or bug fixes, ask the AI to propose a plan, and verify its suggested edits",
            cooldown_sessions: 3,
        },
        Tip {
        ...
        Tip {
            id: "git-worktrees",
            content: "Use git worktrees to run multiple sessions in parallel.",
            cooldown_sessions: 10,
        },
        Tip {
            id: "color-when-multi-clauding",
            content: "Running multiple sessions? Use /color and /rename to tell them apart at a glance.",
            cooldown_sessions: 10,
        },
        Tip {
            id: "shift-enter",
        ...
        Tip {
            id: "memory-command",
            content: "Use /memory to view and manage Uppli memory",
        ...
        Tip {
            id: "prompt-queue",
            content: "Hit Enter to queue up additional messages while the AI is working.",
            cooldown_sessions: 5,
        },
        Tip {
            id: "enter-to-steer-in-realtime",
            content: "Send messages to Claude while it works to steer it in real-time",
            cooldown_sessions: 20,
        },
        Tip {
            id: "todo-list",
            content: "Ask the AI to create a todo list when working on complex tasks to track progress and remain on track",
            cooldown_sessions: 20,
        },
        Tip {
            id: "permissions",
        ...
        Tip {
            id: "custom-commands",
            content: "Create skills by adding .md files to .uppli/skills/ in your project or ~/.uppli/skills/ for skills that work in any project",
            cooldown_sessions: 15,
        },
        Tip {
            id: "shift-tab",
...
impl TipHistory {
    /// Path to the persisted history file: `~/.uppli/tip_history.json`.
    fn history_path() -> Option<std::path::PathBuf> {
        dirs::home_dir().map(|h| h.join(".uppli").join("tip_history.json"))
    }

    /// Load history from `~/.uppli/tip_history.json`.
    ...
    /// Persist history to `~/.uppli/tip_history.json`.
