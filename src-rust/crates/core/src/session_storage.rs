// session_storage.rs — JSONL transcript persistence for the Rust port of Uppli Code.
//
// File layout:  ~/.uppli/projects/{base64url(project_root)}/{session_id}.jsonl
//
...
pub struct TranscriptMessage {
    ...
    /// Version of the Uppli Code binary, mirrors `MACRO.VERSION`.
    #[serde(default)]
    pub version: String,
...
/// Returns the base projects directory: `~/.uppli/projects/`.
