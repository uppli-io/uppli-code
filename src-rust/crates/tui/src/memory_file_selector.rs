...
impl MemoryFileSelectorState {
    ...
    /// - User:    `~/.uppli/UPPLI.md`
    /// - Project: `{project_root}/UPPLI.md`
    /// - Local:   `{project_root}/.uppli/UPPLI.md`
    ///
    ...
    pub fn open(&mut self, project_root: &std::path::Path) {
        ...
        // User-level: ~/.uppli/UPPLI.md
        let user_path = cc_core::config::Settings::config_dir().join("UPPLI.md");
        let user_display = {
        ...
        // Project-level: {project_root}/UPPLI.md
        let project_path = project_root.join("UPPLI.md");
        ...
        // Local-level: {project_root}/.uppli/UPPLI.md
        let local_path = project_root.join(".uppli").join("UPPLI.md");
