...
pub fn render_help_overlay(frame: &mut Frame, overlay: &HelpOverlay, area: Rect) {
    ...
    let block = Block::default()
        ...
        .title(Line::from(vec![
            ...
            Span::styled("— Uppli Code  ", Style::default().fg(Color::DarkGray)),
        ]))
...
// ---------------------------------------------------------------------------
// Pinned-entry persistence  (~/.uppli/history_pins.json)
// ---------------------------------------------------------------------------
...
/// Load the set of pinned entry texts from `~/.uppli/history_pins.json`.
...
/// Persist `pinned_texts` to `~/.uppli/history_pins.json`.
...
impl HistorySearchOverlay {
    ...
    ///
    /// Pinned state is loaded from `~/.uppli/history_pins.json` and applied
    ...
    ///
    /// Persists the updated pin set to `~/.uppli/history_pins.json` and
