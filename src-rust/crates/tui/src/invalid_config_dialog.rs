// invalid_config_dialog.rs — Startup dialog for malformed settings.json or UPPLI.md.
//
...
impl InvalidConfigDialogState {
    ...
    /// Show the dialog with a UPPLI.md parse error.
...
pub fn render_invalid_config_dialog(
    ...
    let title = match state.kind {
        ...
        InvalidConfigKind::ClaudeMd => " Invalid UPPLI.md ",
    ...
    let subtitle = match state.kind {
        InvalidConfigKind::Settings => "~/.uppli/settings.json could not be parsed.",
        InvalidConfigKind::ClaudeMd => "UPPLI.md could not be parsed.",
