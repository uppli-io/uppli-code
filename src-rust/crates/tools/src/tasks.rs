...
static TASK_STORE: Lazy<Arc<DashMap<String, Task>>> = Lazy::new(|| Arc::new(DashMap::new()));
...
impl Tool for TaskCreateTool {
    fn name(&self) -> &str {
        cc_core::constants::TOOL_NAME_TASK_CREATE
    }
...
impl Tool for TaskGetTool {
    fn name(&self) -> &str {
        cc_core::constants::TOOL_NAME_TASK_GET
    }
    fn description(&self) -> &str {
...
impl Tool for TaskUpdateTool {
    fn name(&self) -> &str {
        cc_core::constants::TOOL_NAME_TASK_UPDATE
    }
    fn description(&self) -> &str {
...
impl Tool for TaskListTool {
    fn name(&self) -> &str {
        cc_core::constants::TOOL_NAME_TASK_LIST
    }
    fn description(&self) -> &str {
...
impl Tool for TaskStopTool {
    fn name(&self) -> &str {
        cc_core::constants::TOOL_NAME_TASK_STOP
    }
    fn description(&self) -> &str {
...
impl Tool for TaskOutputTool {
    fn name(&self) -> &str {
        cc_core::constants::TOOL_NAME_TASK_OUTPUT
    }
    fn description(&self) -> &str {
